...
PYME por producto (Agenda $65 · Pedidos $80 · Inmobiliario $249 entry-propuesto/$650 full ·
Integraciones desde $180, todos con setup que ES la adaptación). Es el único que combina **seis**
cosas a la vez:
...
> **Nuevo competidor first-party — Meta Business Agent (jun 2026, ver `../business/estrategia/11-whatsapp-2026-ia-y-tech-provider.md`):**
> Meta lanzó su **propio agente de IA** en WhatsApp/IG/Messenger (gratis para empezar; luego tokens).
> Hace lo genérico que vende el clúster PYME (agenda, califica leads, recomienda) y **comoditiza** el
> "bot que atiende 24/7". **No borra a SoltyAI:** es **autoservicio genérico** (el dueño lo configura
> solo) — el opuesto exacto del moat done-for-you; no trae verticales profundos (para eso Meta empuja
> su plataforma enterprise); cobra por token (nosotros = topes + modo sin IA). **Encuadre de venta:**
> *"Meta te da el motor genérico y te cobra por token; nosotros te lo dejamos funcionando con TU
> negocio, en tu rubro, con costo de IA bajo control."* Bonus: Meta **educa al mercado** → menos costo
> de evangelización; competimos en *implementación/adaptación*, no en *existencia de la categoría*.
...
5. **Precio claro por producto + español de Colombia + soporte local.** Treble, Keybe, Yalo, Aivo,
   Auronix **no publican precio** (sales-led, fricción). SoltyAI gana con transparencia (precio por
   producto: Agenda $65 / Pedidos $80 / Inmobiliario $249 entry-propuesto / Integraciones desde $180)
   y ancla colombiana real (Bucaramanga), contra plataformas que facturan en USD con soporte distante.
...
> Para 3 creatividades (presupuesto US$400, un mensaje por anuncio). Cada uno ataca un hueco
> distinto y evita el copy saturado del §3. Justificación competitiva incluida. La promesa líder
> (tiempo/orden/productividad + done-for-you) es la misma en los tres; cambia el ángulo de entrada.
...
- **Por qué gana:** Permite **segmentación por vertical** en Meta (audiencias distintas por rubro),
  eficiente con US$400, y refuerza el moot del rubro listo. Nadie en PYME-LATAM lo pauta.
...
### Ángulos de reserva (para fase 2 / rotación si A–C cansan):
...
- **E — "Precio claro, soporte en colombiano":** *"Desde $65 al mes por producto, sin cotizaciones
...
- **IA "sí/no":** marqué "Sí" cuando el producto promociona IA generativa/conversacional como
  ...
  operado por humanos.
- **Pricing de SoltyAI:** por producto (ver `05-PRICING.md`). El tier **Inmobiliario entry**
  ($249/$600) va marcado **propuesto (validar)** — el seed/landing hoy solo tienen el full
  ($650/$1.500). **Prohibido** usar los planes viejos Starter/Growth/Pro: están superados.
