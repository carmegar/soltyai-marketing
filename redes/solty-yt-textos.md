# YouTube "SoltyAI" — banner y textos listos para pegar

> Generado 2026-07-22. Banner: `solty-yt-banner.png` (2048×1152, contenido dentro
...
| Campo | Valor |
|---|---|
| **Nombre del canal** | SoltyAI |
| **Handle** | `@soltyai` *(si está tomado: `@soltyai_co`)* |
...
1. Crear el canal de marca desde `youtube.com/channel_switcher` → nombre **SoltyAI**.
2. Personalización → asignar handle `@soltyai`.
3. Subir foto de perfil (`solty-fb-perfil.png`) y banner (`solty-yt-banner.png`).
4. Pegar la descripción + enlace a soltyai.com (aparece sobre el banner).
5. Información de contacto: `carmegar12@gmail.com` por ahora (cambiar al correo @soltyai.com cuando exista).
6. País: Colombia. Idioma: Español.
7. **Solo reserva** — no se opera por ahora (se operan las 3 redes del doc 14).
